...
class DefaultMambularConfig(BaseConfig):
    ...
    use_learnable_interaction: bool = True
    use_cls: bool = False
    use_pscan: bool = False
    enable_state_gain: bool = True
    enable_bi_weight: bool = True
    enable_state_allocation: bool = False
    enable_reset_gate: bool = False
    majority_state_ratio: float = 0.2
